Shader "Basics/TessellatedWavesMyVersion"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        patch[2].uv * barycentricCoordinates.z;
            ...
            tessFactors patchConstantFunc(InputPatch<tessControlPoint, 3> patch)
            {
                ...
                float campPos = _WorldSpaceCameraPos;

                float dist0 = distance(edgePos0, campPos);
                float dist1 = distance(edgePos1, campPos);
                float dist2 = distance(edgePos2, campPos);
